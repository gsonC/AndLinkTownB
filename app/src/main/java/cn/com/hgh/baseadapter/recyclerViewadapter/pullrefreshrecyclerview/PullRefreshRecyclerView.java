...
import cn.com.hgh.baseadapter.recyclerViewadapter.layoutmanager.ILayoutManager;
...
public class PullRefreshRecyclerView extends FrameLayout implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private PullRefreshRecyclerAdapter mAdapter;
    ...
    public void setAdapter(PullRefreshRecyclerAdapter adapter) {
