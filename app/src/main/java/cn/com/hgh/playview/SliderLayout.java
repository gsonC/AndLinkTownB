 ...
 * {@link com.tiger.quicknews.wedget.viewimage.Transformers.androidimageslider.wedget.viewimage.Indicators.daimajia.slider.library.Indicators.PagerIndicator}
 * and
 * {@link com.tiger.quicknews.wedget.viewimage.Transformers.androidimageslider.wedget.viewimage.Tricks.daimajia.slider.library.Tricks.ViewPagerEx}
...
public class SliderLayout extends RelativeLayout {
	...
	/**
	 * @see com.tiger.quicknews.wedget.viewimage.Transformers.androidimageslider.wedget.viewimage.Animations.daimajia.slider.library.Animations.BaseAnimationInterface
	 */
	...
	public SliderLayout(Context context, AttributeSet attrs, int defStyle) {
		...
		mTransformerSpan = attributes.getInteger(
				R.styleable.SliderLayout_pager_animation_span, 1000);
		...
		int visibility = attributes.getInt(
				R.styleable.SliderLayout_indicator_visibility, 1);
	...
	public void addListSlider(ArrayList<BaseSliderView> mImageContents) {
		mSliderAdapter.setmImageContents(mImageContents);
	}
	...
	public boolean ismAutoRecover() {
		return mAutoRecover;
	}

	public void setmAutoRecover(boolean mAutoRecover) {
		this.mAutoRecover = mAutoRecover;
	}
	...
	public enum Transformer {
		Default("Default"), Accordion("Accordion"), Background2Foreground(
				"Background2Foreground"), CubeIn("CubeIn"), CubeOut("CubeOut"), DepthPage(
				...
				"RotateDown"), RotateUp("RotateUp"), Stack("Stack"), ScaleInOut(
				"ScaleInOut"), FlipVertical("FlipVertical"), Tablet("Tablet"), ZoomIn(
				"ZoomIn"), ZoomOutSlide("ZoomOutSlide"), ZoomOut("ZoomOut");
	 ...
	 * details in
	 * {@link com.tiger.quicknews.wedget.viewimage.Transformers.androidimageslider.wedget.viewimage.Animations.daimajia.slider.library.Animations.BaseAnimationInterface}
	 * , and you can see a example in
	 * {@link cn.com.hgh.playview.imp.example.androidimageslider.wedget.viewimage.Animations.daimajia.slider.library.Animations.DescriptionAnimation}
	 * 
	 * @param animation
	 */
	...
	public void setPresetIndicatorV(final PresetIndicators presetIndicator) {
		PagerIndicator pagerIndicator = (PagerIndicator) SliderLayout.this
				.findViewById(presetIndicator.getResourceId());
		SliderLayout.this.mIndicatorVisibility = PagerIndicator.IndicatorVisibility.Visible;
		setCustomIndicator(pagerIndicator);
	}

	public void setPresetIndicator(final PresetIndicators presetIndicator,
			final PagerIndicator.IndicatorVisibility mIndicatorVisibility) {
		PagerIndicator pagerIndicator = (PagerIndicator) SliderLayout.this
				.findViewById(presetIndicator.getResourceId());
		SliderLayout.this.mIndicatorVisibility = mIndicatorVisibility;
		setCustomIndicator(pagerIndicator);
	}
