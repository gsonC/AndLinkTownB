...
public class PagerIndicator extends LinearLayout implements
	...
	/**
	 * This value is from
	 * {@link com.tiger.quicknews.wedget.viewimage.Transformers.daimajia.slider.library.SliderAdapter}
	...
	public PagerIndicator(Context context, AttributeSet attrs) {
		...
		mDefaultUnSelectedColor = attributes.getColor(
				...
				Color.argb(120, 204, 204, 204));
		// Color.argb(120, 255, 255, 255));

		mDefaultSelectedWidth = attributes.getDimension(
				R.styleable.PagerIndicator_selected_width, (int) pxFromDp(8));
		mDefaultSelectedHeight = attributes.getDimensionPixelSize(
				R.styleable.PagerIndicator_selected_height, (int) pxFromDp(8));

		mDefaultUnSelectedWidth = attributes.getDimensionPixelSize(
				R.styleable.PagerIndicator_unselected_width, (int) pxFromDp(8));
