...
public class AbListViewHeader extends LinearLayout {
	...
	/** 进度图标gif. */
	private GifView gifProgressBar;
	...
	private void initView(Context context) {
		...
		headerView.setBackgroundColor(context.getResources().getColor(
				R.color.white));
		...
		gifProgressBar = new GifView(context);
		gifProgressBar.setMovieResource(R.mipmap.hgh);
		...
		headImage.addView(gifProgressBar, layoutParamsWW);
