...
package cn.com.hgh.view.expandablebuttonmenu;
...
public class ExpandableButtonMenu extends RelativeLayout implements View.OnClickListener {
     ...
     *
     * @param button one of {@link MenuButton#LEFT}, {@link MenuButton#}, {@link MenuButton#RIGHT}
     */
...
//            if (mListener != null) mListener.onClick(MenuButton.MID);
    ...
    private void inflate() {
        ...
        sWidth = ScreenUtils.getScreenWidth(getContext());
        sHeight = ScreenUtils.getScreenHeight(getContext());
