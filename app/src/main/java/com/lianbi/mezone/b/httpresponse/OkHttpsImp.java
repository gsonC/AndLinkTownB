...
public enum OkHttpsImp {
     ...
     * 获取桌位信息
     */
    public void getTableInfo(MyResultCallback<String> myResultCallback, String storeId, String tableName) {
        Map<String, String> params = new HashMap<String, String>();
        params.put("storeId", storeId);
    ...
    */
    public void checkTableOrder(MyResultCallback<String> myResultCallback, String storeId, String tableId) {
        Map<String, String> params = new HashMap<String, String>();
        params.put("storeId", storeId);
        params.put("tableId", tableId);
        String url = getHttpUrl(storeId, "checkTableOrder");
        postProgressResponse(myResultCallback, params, url);
    }
   ...
   * 修改桌位订单状态(翻台)
   */
    public void setTableFree(MyResultCallback<String> myResultCallback, String storeId, String tableId) {
        Map<String, String> params = new HashMap<String, String>();
        params.put("storeId", storeId);
        params.put("tableId", tableId);
        String url = getHttpUrl(storeId, "setTableFree");
        postProgressResponse(myResultCallback, params, url);
    }
     ...
     * 打印小票接口
     */
    public void tableInfoPrint(MyResultCallback<String> myResultCallback, String businessId, String tableId) {
        Map<String, String> params = new HashMap<String, String>();
        params.put("businessId", businessId);
        params.put("tableId", tableId);
     ...
     * 桌位详情接口
     */
    public void tableInfo(MyResultCallback<String> myResultCallback, String userId, String businessId, String tableId) {
        Map<String, String> params = new HashMap<String, String>();
        params.put("userId", userId);
        params.put("businessId", businessId);
        params.put("tableId", tableId);
     ...
     * 订单改价接口
     */
    public void editPrice(MyResultCallback<String> myResultCallback, String userId, String businessId, String tableId, String editPrice) {
        Map<String, String> params = new HashMap<String, String>();
        params.put("userId", userId);
        params.put("businessId", businessId);
        params.put("tableId", tableId);
        params.put("editPrice", editPrice);
        params.put("sourceType", "tss");
        String url = getHttpUrl("editPrice");
        postProgressResponse(myResultCallback, params, url);
    }
     ...
     * 现金付款接口
     */
    public void editOrderStatus(MyResultCallback<String> myResultCallback, String userId, String businessId, String tableId) {
        Map<String, String> params = new HashMap<String, String>();
        params.put("userId", userId);
        params.put("businessId", businessId);
        params.put("tableId", tableId);
        params.put("sourceType", "tss");
        String url = getHttpUrl("editOrderStatus");
        postProgressResponse(myResultCallback, params, url);
    }
     ...
     * 添加桌位
     */
    public void getAddTable(MyResultCallback<String> myResultCallback, String businessId,
                            String tableName, String presetCount, String userId) {
        Map<String, String> params = new HashMap<String, String>();
        params.put("userId", userId);
        params.put("businessId", businessId);
        params.put("tableName", tableName);
        params.put("presetCount", presetCount);
        String url = getHttpUrl("addTable");
        postProgressResponse(myResultCallback, params, url);
    }

    private String getHttpUrl(String methodName) {
        return API.TOSTORESERVICE + "/wcm/tssTable/".concat(methodName);
    }
     ...
     * 获取会员分类详情
     */
    public void getMemberTypedetaiL( MyResultCallback<String> myResultCallback,
                                    String typeId, String reqTime, String uuid,
                                    String businessId
                                    ) throws Exception {
        Map<String, String> params = new HashMap<String, String>();
        params.put("businessId", businessId);
   ...
   */
    ...
    * */
     ...
     * 消费结算、呼叫服务、到店明细总数接口
     */
    public void getDiningTableSettingDetail(MyResultCallback<String> myResultCallback, String storeId, String userId, String flagStr) {
        Map<String, String> params = new HashMap<String, String>();
        params.put("storeId", storeId);
        params.put("userId", userId);
        params.put("flagStr", flagStr);
        String url = getHttpUrl(storeId, "getCountPaidPushOrder");
        postProgressResponse(myResultCallback, params, url);
    }
